...
class FaceIO:
    ...
    def __init__(self):
        FaceIO.WEBAPI_IN_URL = FaceIO.urljoin(FaceIO.WEBAPI_SCHEME, FaceIO.WEBAPI_NETLOC, FaceIO.WEBAPI_IN_PATH)
        FaceIO.WEBAPI_OUT_URL = FaceIO.urljoin(FaceIO.WEBAPI_SCHEME, FaceIO.WEBAPI_NETLOC, FaceIO.WEBAPI_OUT_PATH)
    ...
    async def get_label(queue):
        pass

faceio = FaceIO()
loop = asyncio.get_event_loop()
loop.slow_callback_duration = 0.001 
asyncio.ensure_future(faceio.main(loop))
loop.run_forever()
loop.close()
